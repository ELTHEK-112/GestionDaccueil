...
<html lang="en">
<%   
          Responsible rsp = (Responsible)  session.getAttribute("resp"); 
          Service srv = (Service) session.getAttribute("serv");
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <!-- Form validations -->
              ...
              <%
              Responsible rspo = (Responsible) request.getAttribute("respo");
              ...
              %>
                <div class="form">
                  ...
                  <input type="hidden" name="idresp" value="<%=rspo.getID() %>" >
                    <div class="form-group ">
                      <label for="responsiblenom" class="control-label col-lg-2">Nom Responsible : <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input id="responsiblenom" name="responsiblenom" type="text" class="form-control" value="<%=rspo.getNom() %>"/>
                      </div>
                    </div>
                     <div class="form-group">
                        <label for="responsibleprenom" class="control-label col-lg-2">Prnom Responsible: <span class="required">*</span></label>
                       <div class="col-lg-10">
                          <input  id="responsibleprenom" name="responsibleprenom" type="text" size="16" class="form-control" value="<%=rspo.getPrenom() %>">
                       </div>
                     </div>
                      <div class="form-group ">
                      <label for="responsiblecin" class="control-label col-lg-2">CIN Responsible:<span class="required" >*</span></label>
                      <div class="col-lg-10">
                        <input id="responsiblecin" name="responsiblecin" type="text" class="form-control"value="<%=rspo.getCIN() %>"/>
                      </div>
                    </div>  
                    <div class="form-group">
