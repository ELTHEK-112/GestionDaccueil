        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            <a href="javascript:;" class="">
                          ...
                          <span>Tables de Visits</span>
                          <span class="menu-arrow arrow_carrot-right"></span>
                      </a>
            <ul class="sub">
              <li><a class="active" href="basic_visitsAcc.jsp">Les Visites</a></li>
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon_close_alt2"></i> Divition </th>
                 ...
                 for(Object vstlist : vs) {
                  ...
                  if(v.getDivision().getID() == srv.getID()){
