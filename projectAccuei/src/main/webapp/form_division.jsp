  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i> Form Division</h3>
            <ol class="breadcrumb">
        ...
        <!-- Form validations -->
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="get" action="controlerDivision">
                  <input type="hidden" name="command" value="2" />
                    <div class="form-group ">
                      <label for="responsiblenom" class="control-label col-lg-2">Nom Division : <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input id="responsiblenom" name="nomdiv" type="text" class="form-control"/>
                      </div>
                       <%
                       try{
                    	   ResultSet re = SingleConnection.readQury("select MAX(ID) from division");
                             while(re.next()){
                     ...
                     <div class="form-group ">
                      <label for="responsibleid" class="control-label col-lg-2">Division ID: <span class="required">*</span></label>
                      <div class="col-lg-10">
                         <input  id="idServ" readonly class="form-control" name="iddivision" type="text" value="<%=id %>" class="form-control" />
                      	<% 
                             }
                    ...
                    <div class="form-group ">
								<label for="Visitor" class="control-label col-lg-2">Responsible
									: <span class="required">*</span>
								</label>
								<div class="col-lg-10">
									<select class="form-control m-bot15" name="Responsible">
										<%
										List<Responsible> responsibles = (ArrayList<Responsible>) ResponsibleDbUtil.getALL();
										...
										%>
										<option value="<%out.print(resp.getID());%>">
											<%
												out.print(resp.getNom() + " " + resp.getPrenom());
											%>
										</option>
										<%
