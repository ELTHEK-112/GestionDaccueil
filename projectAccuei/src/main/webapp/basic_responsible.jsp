				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-th-list"></i>Basic Responsible</li>
						</ol>
					</div>
				</div>
				<div class="row">
						...
						<section class="panel">
							...
							<table class="table table-striped table-advance table-hover">
								<tbody>
									...
									if(request.getAttribute("rspon") == null){
										re = ResponsibleDbUtil.getALL();
									}else{
									
										 re = (ArrayList) request.getAttribute("rspon");
									}
									
										for (int i = 0; i < re.size(); i++) {
											

											Responsible resp = (Responsible) re.get(i);
											if(resp.getID() != responsible.getID() ){
