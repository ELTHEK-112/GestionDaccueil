          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li>
                ...
                <a href="login.jsp?id="><i class="icon_key_alt"></i> Log Out</a>
              </li>
            </ul>
          </li>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
         ...
         <%
        try{
         ResultSet st = SingleConnection.readQury("select COUNT(ID) from division ");
        int cont;
         while(st.next()){
        	 cont = st.getInt(1);
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
											<div class="card-box noradius noborder bg-warning">
													...
													<h6 class="text-white text-uppercase m-b-20">Division</h6>
									       ...
									       <%
									       try{
         ResultSet st1 = SingleConnection.readQury("select  COUNT(ID) from responsible");
        int cont1;
         while(st1.next()){
        	 cont1 = st1.getInt(1);
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
											<div class="card-box noradius noborder bg-warning">
													<i class="fa fa-bar-chart float-right text-white"></i>
													<h6 class="text-white text-uppercase m-b-20">Responsable</h6>
