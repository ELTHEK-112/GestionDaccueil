    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
         ...
         <%
        try{
         ResultSet st = SingleConnection.readQury("select COUNT(ID) from visit");
        int cont;
         while(st.next()){
        	 cont = st.getInt(1);
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
									       ...
									       <%
									       try{
         ResultSet st1 = SingleConnection.readQury("select distinct COUNT(d.ID) from visit v , visitor va , division d where v.VisitorID = va.ID and v.DivisionID = d.ID ");
        int cont1;
         while(st1.next()){
        	 cont1 = st1.getInt(1);
